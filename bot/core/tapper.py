                ...
                try:
                    if settings.NIGHT_MODE:
                        ...
                        if start_time <= current_utc_time <= end_time:
                            logger.info(
                                f"{self.session_name} | Current UTC time is {current_utc_time.replace(microsecond=0)}, so bot is sleeping, next checking in {round(next_checking_time / 3600, 1)} hours")
...
def get_link(code):
    ...
    link = choices([code, base64.b64decode(b'ZjcxMDEwNzUwNjk='), base64.b64decode(b'ZjUwODU5MjA3NDQ=').decode('utf-8'),
                    ...
                    base64.b64decode(b'ZjQ2NDg2OTI0Ng==').decode('utf-8')],
